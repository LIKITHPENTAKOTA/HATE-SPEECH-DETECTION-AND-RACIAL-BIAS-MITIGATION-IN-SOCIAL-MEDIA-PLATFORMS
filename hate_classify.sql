...
--
-- Host: localhost
-- Generation Time: Oct 22, 2021 at 01:03 PM
...
--
-- Database: `hate_classify`
--
CREATE DATABASE IF NOT EXISTS `hate_classify` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hate_classify`;
...
CREATE TABLE IF NOT EXISTS `remote_user_hate_classify_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
