"""hate_classify URL Configuration
...
from hate_classify import settings
...
urlpatterns = [
    ...
    url(r'^Predict_TweetClassify_Type/$', remoteuser.Predict_TweetClassify_Type, name="Predict_TweetClassify_Type"),
    ...
    url(r'^View_TweetClassify_Type_Ratio/$', serviceprovider.View_TweetClassify_Type_Ratio, name="View_TweetClassify_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_TweetClassify_Type/$', serviceprovider.View_Prediction_Of_TweetClassify_Type, name="View_Prediction_Of_TweetClassify_Type"),
